...
public class VanillaCommonEss extends AbstractCommandEssence {
    
    public VanillaCommonEss() {
        super(LunarMod.Prefix("VanillaCommonEss"));
        core = Color.WHITE.cpy();
        glow = Color.WHITE.cpy();
        init();
    }
    ...
    @Override
    public int getPrice() {
        return LunarRarity.COMMON.coins() * 2;
    }
